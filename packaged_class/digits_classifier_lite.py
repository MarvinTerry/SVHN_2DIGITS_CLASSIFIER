...
if __name__ == '__main__':
    digits_classifier_lite = DIGITS_CLASSIFIER_LITE('models/svhn_2digits_model.tflite')
    ...
    predicted_labels, predicted_confs = digits_classifier_lite.predict_from_directory('custom_images')
    print(predicted_labels, predicted_confs)